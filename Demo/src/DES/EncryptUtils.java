...
public class EncryptUtils {  
    ...
    public static void main(String[] args) throws Exception {
		String number="andy";
		String key="znuser!@#&*(8964";
		System.out.println("加密后："+Encrypt3DES(number,key));
		System.out.println("解密后："+Decrypt3DES(Encrypt3DES(number,key),key));
		
		System.out.println("解密后："+Decrypt3DES("uniWjjL3RerTDMSzAUjjog==", key));
		System.out.println("realname:");
		System.out.println("sxh:");
		System.out.println("username:andy  5Jw/N1T2wDk=  5Jw/N1T2wDk=  5Jw/N1T2wDk=");
