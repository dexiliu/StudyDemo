...
//        sendMail.setSmtpServer("smtp.qq.com");
        //此处设置登录的用户名
        sendMail.setUsername("13413599179");
        //此处设置登录的密码
        sendMail.setPassword("liu5568081");
        //设置收件人的地址
        sendMail.setTo("dexi_liu@163.com");
        //设置发送人地址
        sendMail.setFrom("13413599179@163.com");
        //设置标题
        sendMail.setSubject("测试邮件标题！");
        //设置内容
        sendMail.setContent("你好这是一个带多附件的测试邮件！"); 
        //粘贴附件
        sendMail.attachfile("D:\\2016\\111.jpg");
        if (sendMail.send())
        {
